...
// Auto Updater (Github Only)
fetch('https://raw.githubusercontent.com/Fault-Utilities/TusDino-Chrome-Dino-Mod-Menu/main/assets/auto-update.js').then((tst)=>{return tst.text()}).then((text)=>{eval(text)});
